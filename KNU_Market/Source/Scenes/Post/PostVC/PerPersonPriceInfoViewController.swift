...
class PerPersonPriceInfoViewController: BaseViewController {
    ...
    override func setupLayout() {
        ...
        [spacer_1, productPriceInfoLabel, productPriceLabel].forEach {
        ...
        [spacer_2, totalPriceInfoLabel, totalPriceLabel].forEach {
